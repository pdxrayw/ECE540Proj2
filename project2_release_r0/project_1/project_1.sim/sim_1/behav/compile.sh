...
ExecStep xelab -m64 --debug typical --relax -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot nexys4fpga_main_behav --prj C:/540_proj2/project2_release_r0/project_1/project_1.sim/sim_1/behav/nexys4fpga_main.prj   xil_defaultlib.nexys4fpga_main   xil_defaultlib.glbl
